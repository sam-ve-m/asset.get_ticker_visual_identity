from func.src.service import create_url_path, check_if_url_is_valid
...
def test_when_region_br_and_symbol_valid_then_create_url():
    ...
    url_path = create_url_path(params)
...
def test_when_region_us_and_symbol_is_invalid_str_then_create_invalid_url():
    ...
    url_path = create_url_path(params)
    assert url_path == "https://sigame-companies-logo.s3.sa-east-1.amazonaws.com/us/AAPL123.png"
